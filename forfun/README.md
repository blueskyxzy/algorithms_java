# forfun serverless API
The forfun project, created with [`aws-serverless-java-container`](https://github.com/awslabs/aws-serverless-java-container).
...
```bash
$ mvn archetype:generate -DartifactId=forfun -DarchetypeGroupId=com.amazonaws.serverless.archetypes -DarchetypeArtifactId=aws-serverless-springboot2-archetype -DarchetypeVersion=1.3.1 -DgroupId=com.xzy -Dversion=1.0-SNAPSHOT -Dinteractive=false
$ cd forfun
$ mvn clean package
